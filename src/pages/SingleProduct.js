                        ...
                        <div className='main-product-details'>
                            ...
                            <div className='py-3'>
                                ...
                                <div className='d-flex align-items-center gap-15 flex-row mt-2 mb-3'>
                                    ...
                                    <div className=''>
                                        <input type='number' name='' min={1} max={100} defaultValue={1} className='form-control' style={{ 'width': '70px' }} id='' />
                                    </div>
                                ...
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    ...
                                    <a href='javascript:void(0);' onClick={() => copyToClipboard('https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg')}>Copy Product Link</a>
                                </div>
                            </div>
                        </div>
                    </div>
